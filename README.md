...
The deployed contracts and all transactions related to the deployed version of [Jamii Ballots](https://jamii-ballots.vercel.app/) can be found at the following contract addresses in the respecitve test networks.
